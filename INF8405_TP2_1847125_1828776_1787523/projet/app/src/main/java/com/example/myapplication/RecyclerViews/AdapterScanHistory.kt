...
class AdapterScanHistory(private val bluetoothList: ArrayList<ModelDetails>) : RecyclerView.Adapter<AdapterScanHistory.ViewHolder>() {
        ...
        fun bindItems(bluetoothItem: ModelDetails) {
            ...
            itemView.setOnClickListener {
                ...
                dialogBuilder.setMessage(bluetoothItem.description)
                    ...
                    .setNeutralButton("Enlever de l'historique") { dialog, _ ->
                        val intent = Intent("remove-history")

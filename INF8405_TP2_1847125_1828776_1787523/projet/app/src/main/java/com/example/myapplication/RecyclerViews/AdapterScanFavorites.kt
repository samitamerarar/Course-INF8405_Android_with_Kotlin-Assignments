...
class AdapterScanFavorites(private val bluetoothList: ArrayList<ModelDetails>) : RecyclerView.Adapter<AdapterScanFavorites.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bindItems(bluetoothItem: ModelDetails) {
            ...
            itemView.setOnClickListener {
                ...
                dialogBuilder.setMessage(bluetoothItem.description)
                    .setCancelable(true)
                    ...
                    .setNeutralButton("Enlever des favoris") { dialog, _ ->
                        val intent = Intent("remove-favorite")
